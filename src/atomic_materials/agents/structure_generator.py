"""Structure generation agent for ATOMIC workflow."""
...
def _format_miller_indices(indices) -> str:
    ...
    if isinstance(indices, str):
        ...
        return indices.replace("(", "").replace(")", "").replace(" ", "").replace(",", "")
...
def generate_structure(state: WorkflowState) -> WorkflowState:
    ...
    try:
        ...
        state.structure_info = {
            ...
            "face": _format_miller_indices(getattr(parsed_params, "surface_miller_indices", None)),
